...
public class NoteDTO {
    ...
    private String lyrics;    // Lyrics associated with the note (if any)
    private double duration;  // Duration of the note in seconds
    private Long audioFileId; // ID of the associated audio file

    public NoteDTO() {
        // This constructor is intentionally empty.
    }

    public NoteDTO(float pitch, double startTime, double endTime, String lyrics, double duration, Long audioFileId) {
        this.pitch = pitch;
        this.startTime = startTime;
        this.endTime = endTime;
        this.lyrics = lyrics;
